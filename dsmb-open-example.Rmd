...
This report uses the example data set `NIDA-CTN-0051` available at `https://datashare.nida.nih.gov/show-data-for-study/nida-ctn-0051`. I do not have permission to redistribute this dataset, but it is freely available with an online data sharing agreement. 
...
protocol <- file("protocol-frag-01.txt", open="r")
x <- readLines(protocol)
close(protocol)
cat(paste(x, collapse="\n"))
rm(list=c("protocol", "x"))
```
